...
const certificationDetails = {
  codepath: {
    ...
    certificate: "./images/certificate/codepathcyb.png",
  },
  networkPlus: {
    title: "CompTIA Network+",
    certificate: "./images/certificates/network-plus.png",
  },
};
...
projectButtons.forEach((button) => {
  button.addEventListener("click", () => {
    if (button.dataset.collection === "certifications") {
      ...
      const certificateFile = certification ? certification.certificate : "";
      ...
      if (certification) {
        activeGalleryImages = [certificateFile];
